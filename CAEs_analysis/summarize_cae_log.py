...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Summarize a CAE matching log file.")
    parser.add_argument("logfile", help="Path to the log file to summarize")
    ...
    try:
        ...
        print(f"❌ Could not read file: {args.logfile}\nError: {e}")
        sys.exit(1)
