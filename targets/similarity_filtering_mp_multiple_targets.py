...
if __name__ == "__main__":
    ...
    target_entries = ['ABADOX', 'ABABIP', 'GASQOK',
                      'ABEKIE','NIWPUE01','ABEKIF',
                      'ABEHAU','EGEYOG','XIDTOW',
                      'ACNCOB10','TACXUQ','ACAZFE',
                      'NIVHEJ','ADUPAS','DAJLAC',
                      'OFOWIS','CATSUL','HESMUQ01',
                      'GUDQOL', 'AKOQOH', 'ADARUT',
                      'BACXUY', 'ABEVAG', 'ABONUD',
                      'ACOVUL', 'AFECIA', 'ABAGET',
                      'ADUTEC', 'ALCFEB', 'APUFEX',
                      'ABOBUP', 'ACOVUL', 'AFIXEV'] 
